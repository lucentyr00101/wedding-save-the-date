<template>
  <div>
    ...
    <SendRsvp />
    <div class="animate__animated initial-hide details">
      <div class="divider"></div>
      <p class="date initial-hide">Saturday, 23rd September, 2023</p>
      <div class="row venue-container initial-hide">
        <div class="col venue">
          <p>Church: St Michael</p>
          <p>The Archangel Parish, BGC</p>
          <p>4 PM - 6 PM</p>
        </div>
        <div class="col venue">
          <p>Reception: Alta Guia, Taguig</p>
          <p>7 PM - 11 PM</p>
        </div>
      </div>
      <p class="rsvp-text">PLEASE SEND RSVP BY OWL BEFORE JULY 30TH</p>
      <div class="divider"></div>
      <div class="row">
        <div class="col">
